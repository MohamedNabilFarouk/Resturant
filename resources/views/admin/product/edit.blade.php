    ...
    <div class="container-fluid page__container p-2">
        ...
        <div class="card rounded card-form__body card-body shadow-lg">
            <form method="post" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data">
                ...
                <input type="hidden" value="{{count($product->prices)}}" id="count">


                @foreach($product->prices as $key=>$p)

                    <div class="row">

                        <div class="col-3">
                            <label>Size</label>
                            <input type="text" class="form-control"  name="arr[{{$key}}][size]" placeholder="Size" value="{{$p->size}}">

                        </div>
                        <div class="col-3">
                            <label>Price</label>
                            <input type="text" class="form-control"  name="arr[{{$key}}][extra_price]"placeholder="L.E." value="{{$p->price}}">
                        </div>
                    </div>
                @endforeach
                <div id="price_field">
                ...
                <br>
                <input type="button" class="btn btn-dark float-md-right bt-sm" id='more' onclick="add_more_field();" value="add more +" width="10px">
                <br>
