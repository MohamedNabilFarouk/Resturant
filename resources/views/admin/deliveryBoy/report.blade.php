                ...
                <table class="table table-hover table-hover" style="width: 100%;">
                    ...
                    <tbody class="border-3">
                        ...
                        <tr class="text-center border-3 m-auto">
                            <td>{{ $index }}</td>
                        <td class="col-md-9"><em>{{ $order->count() }}</em><br>
                            @foreach($daily_orders[$index] as $d)
                            <em> {{ $d->region->name_en ?? '' }}<em><br>
                                @php
                                    $total_day += $d->region->fees;
                                     
                                    
                                @endphp
                                @endforeach
                        </td>
                            <td class="col-md-9"><em>{{ $total_day }}</em></td>
                        </tr>
                                @php
                        ...
                        <tr class="text-center border-3 m-auto">
                            ...
                            <td class="col-md-9"><em>{{ $total_week }}</em></td>
                        </tr>
