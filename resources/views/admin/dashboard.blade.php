                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <a href="{{ route('order.ByStatus', 'Delivered') }}"
                                            class="text-warning fw-bold fs-6">@lang('site.Weekly Sales')
                                            Count:{{ $weekly_sales->count() }}</a> <br />
                                        <a href="{{ route('order.ByStatus', 'Delivered') }}"
                                            class="text-warning fw-bold fs-6">@lang('site.Total'):
                                            {{ $weekly_sales->sum('total') }} &pound;</a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                        ...
                                        <a href="{{ route('order.ByStatus', 'Pending') }}"
                                            class="text-danger fw-bold fs-6 mt-2">@lang('site.Total'):
                                            {{ $pending_orders->sum('total') }}</a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col bg-light-success px-6 py-8 rounded-2">
                                        ...
                                        <a href="{{ route('order.ByStatus', 'Confirmed') }}"
                                            class="text-success fw-bold fs-6 mt-2">@lang('site.Confirmed Orders')</a>
                                        <a href="{{ route('order.ByStatus', 'Confirmed') }}"
                                            class="text-success fw-bold fs-6 mt-2">@lang('site.Count'):
                                            {{ $confirmed_orders->count() }}</a> <br />
                                        <a href="{{ route('order.ByStatus', 'Confirmed') }}"
                                            class="text-success fw-bold fs-6 mt-2">@lang('site.Total'):
                                            {{ $confirmed_orders->sum('total') }}</a>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="card-header rounded border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-bold fs-7">@lang('site.More than')
                                    {{ $latest_products_day->count() + $latest_products_week->count() + $latest_products_month->count() }}
                                ...
                                <div class="tab-pane fade show active" id="kt_table_widget_5_tab_1">
                                    ...
                                    <div class="table-responsive rounded">
                                        ...
                                        <table
                                            ...
                                            <!--begin::Table head-->
                                            <thead>
                                                <tr class="text-center border-3border-0">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($latest_products_month as $p)
                                                    <tr class="text-center border-3 m-auto">
                                                         <td class="px-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-5">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    <a href="{{ route('product.edit', $p->id) }}"
                                                                        class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $p->name_en }}</a>
                                                                    <span
                                                                        class="text-muted fw-bold text-muted d-block fs-7">{{ $p->name_ar }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                         <td class="px-3">
                                                            <a href="{{ route('product.edit', $p->id) }}"
                                                                ...
                                                                class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $p->category->name_en ?? '' }}</a>
                                                        </td>
                                                        <?php
                                                        ...
                                                        ?>
                                                         <td class="px-3">
                                                            <a href="{{ route('product.edit', $p->id) }}"
                                                                class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $price }}</a>
                                                        </td>
                                                         <td class="px-3">
                                                            <a href="{{ route('product.edit', $p->id) }}"
                                                                class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $p->cal }}</a>
                                                        </td>
                                                         <td class="px-3">
                                                            @if ($p->veg == 1)
                                                                <span
                                                                    class="badge badge-light-primary fs-7 fw-bold">@lang('site.Vegetarian')</span>
                                                            @else
                                                                <span
                                                                    class="badge badge-light-primary fs-7 fw-bold">@lang('site.Non
                                                                    Vegetarian')</span>
                                                        </td>
                                                @endif
                                                 <td class="px-3">
                                                    @if ($p->promotional == 1)
                                                        <span
                                                            class="badge badge-light-primary fs-7 fw-bold">@lang('site.Yes')</span>
                                                    @else
                                                        <span
                                                            class="badge badge-light-primary fs-7 fw-bold">@lang('site.No')</span>
                                                </td>
                                                @endif
                                                 ...
                                                 <td class="px-3">
                                                    @if ($p->status == 1)
                                                        <span
                                                            class="badge badge-light-primary fs-7 fw-bold">@lang('site.Active')</span>
                                                    @else
                                                        <span class="badge badge-light-primary fs-7 fw-bold">@lang('site.Non
                                                            Active')</span>
                                                </td>
                                                @endif
                                ...
                                <div class="tab-pane fade" id="kt_table_widget_5_tab_2">
                                    ...
                                    <div class="table-responsive rounded">
                                        ...
                                        <table
                                            ...
                                            <!--begin::Table body-->
                                            <tbody>
                                                @foreach ($latest_products_week as $p)
                                                    <tr class="text-center border-3 m-auto">
                                                         <td class="px-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-5">
                                ...
                                <div class="tab-pane fade" id="kt_table_widget_5_tab_3">
                                    ...
                                    <div class="table-responsive rounded">
                                        ...
                                        <table
                                            ...
                                            <!--begin::Table body-->
                                            <tbody>
                                                @foreach ($latest_products_day as $p)
                                                    <tr class="text-center border-3 m-auto">
                                                         <td class="px-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-5">
